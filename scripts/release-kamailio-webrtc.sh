...
RUNTIME_KIT_DIR="$(find_runtime_kit)" || {
  printf '[mnscloud-kamailio-webrtc] ERROR: mnscloud-runtime-kit lib/release.sh not found\n' >&2
  exit 1
}
...
mrtk_release_prepare \
  --product mnscloud-kamailio-webrtc \
  --repository manaoscloud/mnscloud-kamailio-webrtc \
